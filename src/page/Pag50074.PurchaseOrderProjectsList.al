page 50074 "Purchase Order Projects List"
{
    // IMP1.01,26-Apr-16,ST: Created new page. This page is replica of "Page 9307"(Verions List: NAVW17.00,NAVNA7.00,SE0.55.12");
    Caption = 'Purchase Order Projects List';
    CardPageID = "Purchase Order Projects";
    Editable = false;
    PageType = List;
    SourceTable = "Purchase Header";
    SourceTableView = WHERE("Document Type"=CONST(Order), "Project Order"=CONST(true));
    ApplicationArea = All;
    UsageCategory = Lists;
