page 50045 "Repair Return Orders-RO"
{
    // IMP1.01,11-Feb-16,ST: Created new page. IMP1.01,1-Feb-16,ST: Created new page.
    Caption = 'Repair Return Orders';
    DelayedInsert = false;
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ...
    SourceTableView = WHERE("Document Type"=FILTER("Return Order"), "Repair Order"=CONST(true));
    ...
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; "Repair Return Order Subform-RO")
            {
