page 50093 "Contacts - Unassigned"
{
    ...
    // IMP1.02,SP5333,02/14/17,ST: Added fiter to page SourceTableView on salesperson code.
    ...
    PageType = List;
    SourceTable = Contact;
    SourceTableView = SORTING("Company Name", "Company No.", Type, Name)WHERE("Salesperson Code"=FILTER(''));
    ApplicationArea = All;
    UsageCategory = Lists;
