report 50006 "LIVE TEST INvoice"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './LIVE TEST INvoice.rdl';
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            if TempSalesInvoiceLine.Type.AsInteger() = 0 then begin
                                ...
                                if TempSalesInvoiceLine.Type = TempSalesInvoiceLine.Type::"G/L Account" then TempSalesInvoiceLine."No." := '';
    ...
    begin
        ...
        FormatAddress.Company(CompanyAddressRemit, CompanyInformation) // End ===========================================================/
    end;
