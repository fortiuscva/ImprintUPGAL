report 60022 "Return Receipt Ext"
{
    // version NAVNA14.00
    DefaultLayout = RDLC;
    RDLCLayout = './Return Receipt.rdl';
    ...
    dataset
    {
        dataitem("Return Receipt Header"; "Return Receipt Header")
        {
            ...
            RequestFilterHeadingML = ENU = 'Return Receipt', ESM = 'Recepción de devolución', FRC = 'Réception de retour', ENC = 'Return Receipt';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ReturnReceiptHeaderShipmentDate; "Return Receipt Header"."Posting Date")
                    {
                    }
