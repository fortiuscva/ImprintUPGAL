report 60000 "Customer - Order Detail Ext"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Customer - Order Detail.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    if "Shipment Date" <= WorkDate then BackOrderQty:="Outstanding Quantity"
                    else
                        BackOrderQty:=0;
                    Currency.InitRoundingPrecision;
                    if "VAT Calculation Type" in["VAT Calculation Type"::"Normal VAT", "VAT Calculation Type"::"Reverse Charge VAT"]then SalesOrderAmount:=Round((Amount + "VAT Base Amount" * "VAT %" / 100) * "Outstanding Quantity" / Quantity / (1 + "VAT %" / 100), Currency."Amount Rounding Precision")
                    else
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                trigger OnAfterGetRecord();
                begin
                    if Number = 1 then OK:=CurrencyTotalBuffer.Find('-')
                    else
        ...
        dataitem(Integer2; "Integer")
        {
            ...
            trigger OnAfterGetRecord();
            begin
                if Number = 1 then OK:=CurrencyTotalBuffer2.Find('-')
                else
    ...
    var Text000: TextConst ENU = 'Shipment Date: %1', ESM = 'Fecha envío: %1', FRC = 'Date de livraison : %1', ENC = 'Shipment Date: %1';
