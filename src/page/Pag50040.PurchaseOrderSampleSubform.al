page 50040 "Purchase Order Sample Subform"
{
    ...
    // 
    // IMP1.01,1-Feb-16,ST: Created new page. This page is replica of "Page 54"(ver: NAVW17.00,NAVNA7.00,SE0.55.08,DP6,ISS2.00).
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    LinksAllowed = false;
