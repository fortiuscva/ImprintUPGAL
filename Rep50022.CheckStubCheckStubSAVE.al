report 50022 "Check (Stub/Check/Stub)SAVE"
{
    // <changelog>
    //   <add id="NA0000" dev="JNOZZI" date="2006-07-06" area="CHECKPRINT" feature="286"
    //     releaseversion="NAVNA5.00">Copy of Localized Report #1401 - but in Stub/Check/Stub layout.</add>
    //   <change id="NA0001" dev="JNOZZI" date="2007-08-27" area="CHECKPRINT"  request="27605"
    //     baseversion="NAVNA5.00" releaseversion="NAVNA5.00.01">Fix W1 bug (PS#27396) where check was not adding up
    //     correctly and some other issue having to do with Payment Discounts and Credit Memos was also fixed.</change>
    //   <change id="NA0002" dev="ELYNCH" date="2007-10-30" area="CHECKPRINT"  request="28815"
    //     baseversion="NAVNA5.00.01" releaseversion="NAVNA5.00.01">Add W1 bug (PS#28815) for rep 1401. Check Ledger
    //     Entries not being created.</change>
    //   <change id="NA0003" dev="MBAHADUR" date="2007-12-03" area="CHECKPRINT" feature="31622"
    //     baseversion="NAVNA5.00.01" releaseversion="NAVNA5.00.01">Modify to Show Posting Description.</change>
    //   <change id="NA0004" dev="JNOZZI" date="2007-12-21" area="CHECKPRINT"  request="31873"
    //     baseversion="NAVNA5.00.01" releaseversion="NAVNA5.00.01">Remove carry-forward totals from Check Stubs; they
    //     were causing actual check-stub lines to be dropped.</change>
    //   <change id="NA0005" dev="V-FRXUE" date="2008-06-02" area="CHECKPRINT" feature="NC14261"
    //     baseversion="NAVNA5.00.01" releaseversion="NAVNA6.00">Report Transformation - local Report Layout.</change>
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './Check (StubCheckStub)SAVE.rdl';
    ...
    dataset
    {
        ...
        dataitem(TestGenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                ...
                CompanyInfo.Get;
                BankAcc2.Get(BankAcc2."No.");
                BankCurrencyCode := BankAcc2."Currency Code"; //NA0005
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    begin
                        if not TestPrint then begin
                            if FoundLast then begin
                                if RemainingAmount <> 0 then begin
                                    ...
                                    CurrentLineAmount := LineAmount2; // NA0002
                                    LineDiscount := 0;
                                    RemainingAmount := 0;
                                    //NA0003.begin
                        ...
                        Stub2PostingDesc[Stub2LineNo] := PostingDesc; //NA0003
                                                                      //NA0005.END
                    end;
                    ...
                    begin
                        ...
                        if PreprintedStub then begin
                            ...
                            Stub2PostingDescHeader := USText017; //NA0003
                        end;
                ...
                begin
                    ...
                    // NA0004.begin
                    // Stub2TransportLabel := '';
                    // Stub2TransportDiscount := 0;
                    // Stub2TransportNetAmount := 0;
                    // NA0004.end
                end;
    ...
    begin
        ...
        // NA0001.begin
        // IF (((CustLedgEntry2."Document Type" = CustLedgEntry2."Document Type"::Invoice) OR
        ...
        // NA0001.end
        // NA0001.begin
        if ((((CustLedgEntry2."Document Type" = CustLedgEntry2."Document Type"::Invoice) and (LineAmount2 >= RemainingAmount2)) or ((CustLedgEntry2."Document Type" = CustLedgEntry2."Document Type"::"Credit Memo") and (LineAmount2 <= RemainingAmount2))) and (GenJnlLine."Posting Date" <= CustLedgEntry2."Pmt. Discount Date")) or CustLedgEntry2."Accepted Pmt. Disc. Tolerance" // NA0001.end
 then begin
