report 60005 "Vendor - Payment Receipt Ext"
{
    ...
    ENU = 'Currency Code', ESM = 'Cód. divisa', FRC = 'Code devise', ENC = 'Currency Code')label(PageCaption;
    ENU = 'Page', ESM = 'Pág.', FRC = 'Page', ENC = 'Page')label(DocDateCaption;
    ENU = 'Document Date', ESM = 'Fecha emisión documento', FRC = 'Date document', ENC = 'Document Date')label(EmailCaption;
    ENU = 'Email', ESM = 'Correo electrónico', FRC = 'Courriel', ENC = 'Email')label(HomePageCaption;
