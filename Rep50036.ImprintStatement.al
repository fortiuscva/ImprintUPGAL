...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Imprint Statement.rdl';
    Caption = 'Statement';
    ApplicationArea = all;
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                if PrintLine then CustBalance:=CustBalance + Amount;
                            end;
                    ...
                    trigger OnAfterGetRecord()
                    begin
                        if Number = 1 then Currency2.Find('-')
                        ...
                        if not EntriesExists then CurrReport.Skip;
                    end;
                    trigger OnPreDataItem()
                    begin
            ...
            begin
                ...
                if PrintAllHavingBal then begin
                    if Currency2.Find('-')then repeat Cust2.SetRange("Date Filter", 0D, EndDate);
                            Cust2.SetRange("Currency Filter", Currency2.Code);
                            Cust2.CalcFields("Net Change");
                ...
                if not CurrReport.Preview then begin
                    ...
                    "Last Statement No.":="Last Statement No." + 1;
                if LogInteraction then if not CurrReport.Preview then SegManagement.LogDocument(7, Format("Last Statement No."), 0, 0, DATABASE::Customer, "No.", "Salesperson Code", '', Text003 + Format("Last Statement No."), '');
            end;
            trigger OnPreDataItem()
            begin
                ...
                if Currency.Find('-')then repeat Currency2:=Currency;
                        Currency2.Insert;
    ...
    procedure SkipReversedUnapplied(var DtldCustLedgEntries: Record "Detailed Cust. Ledg. Entry"): Boolean var
        CustLedgEntry: Record "Cust. Ledger Entry";
    begin
