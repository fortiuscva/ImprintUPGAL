report 50019 "Imprint Custom Quote 1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Imprint Custom Quote 1.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInformation1Picture; CompanyInformation1.Picture)
                    {
                    }
                    ...
                    column(SPDocBanner; SPCompanyInfo."Document Banner")
                    {
                    }
                    ...
                    column(SPEmail; StrSubstNo('Email: %1', SalesPurchPerson."E-Mail"))
                    {
                    }
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(NoVarGbl; NoVarGbl)
                        {
                        }
                        //B2BMSOn06Dec2022>>
                        column(LineNo_TempSalesLine; Tempsalesline."Line No.")
                        {
                        }
                        //B2BMSOn06Dec2022<<
                        trigger OnAfterGetRecord()
                        begin
                            ...
                            //IM1.03 Start
                            Clear(NoVarGbl);
                            if TempSalesLine."Item Reference No." <> '' then
                                NoVarGbl := TempSalesLine."Item Reference No."
                            else
                                NoVarGbl := TempSalesLine."No.";
                            //IM1.03 End
            ...
            begin
                ...
                if SPCompanyInfo.FindFirst then begin
                    ...
                    CompanyInfo1.TransferFields(SPCompanyInfo);
                    CompanyInfo2.TransferFields(SPCompanyInfo);
                    CompanyInfo3.TransferFields(SPCompanyInfo);
