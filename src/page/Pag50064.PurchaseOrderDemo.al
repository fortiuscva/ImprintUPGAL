page 50064 "Purchase Order Demo"
{
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Order), "Demo Order" = CONST(true));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "Purchase Order Demo Subform")
            {
    ...
    actions
    {
        ...
        area(processing)
        {
            action("Save and Send")
            {
                ...
                trigger OnAction()
                begin
                    // CurrPage.Zetadocs.PAGE.SaveAndSend(10122);
                end;
            }
            group(Action13)
            {
