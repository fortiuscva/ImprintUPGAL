report 60009 "Service Order Ext"
{
    // version NAVW114.00,NAVNA14.00
    DefaultLayout = RDLC;
    RDLCLayout = './Service Order.rdl';
        ...
        dataitem("Service Header"; "Service Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PO_CaptionLbl; PONumberCaptionLbl)
                    {
                    }
                    column(CustomerPONo_ServiceHeader; "Service Header"."Customer PO No.")
                    {
                    }
                    column(Customer_Caption;'Customer #')
                    {
                    }
                    column(CustomerNo_ServiceHeader; "Service Header"."Customer No.")
                    {
                    }
                    ...
                    dataitem("Service Line"; "Service Line")
                    {
                        ...
                        begin
                            if ShowQty = ShowQty::Quantity then begin
                                ...
                                GrossAmt:=TempSalesTaxAmountLine.GetTotalTaxAmountFCY * ExchangeFactor; //IMP1.01
                            end
                            else
                            begin
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(NoOfCopies; NoOfCopies)
                    {
                        ...
                        ToolTipML = ENU = 'Specifies how many copies of the document to print.', ESM = 'Especifica cuántas copias del documento se van a imprimir.', FRC = 'Spécifie le nombre de copies du document à imprimer.', ENC = 'Specifies how many copies of the document to print.';
                    }
                    ...
                    {
                        ApplicationArea = Service;
                        CaptionML = ENU = 'Amounts Based on', ESM = 'Importes basados en', FRC = 'Montants basés sur', ENC = 'Amounts Based on';
                        OptionCaptionML = ENU = 'Quantity,Quantity Invoiced', ESM = 'Cantidad,Cantidad facturada', FRC = 'Quantité,Quantité facturée', ENC = 'Quantity,Quantity Invoiced';
                        ToolTipML = ENU = 'Specifies the amounts that the service order is based on.', ESM = 'Especifica los importes en los que se basa el pedido de servicio.', FRC = 'Spécifie les montants sur lesquels la commande service est basée.', ENC = 'Specifies the amounts that the service order is based on.';
                    }
                }
            }
        }
    ...
    var Text001: TextConst ENU = 'Service Order %1', ESM = 'Pedido servicio %1', FRC = 'Commande service %1', ENC = 'Service Order %1';
    Text002: TextConst ENU = 'Page %1', ESM = 'Pág. %1', FRC = 'Page %1', ENC = 'Page %1';
    ...
    CompanyAddr: array[10]of Text[100];
    CopyText: Text[30];
    DimText: Text[120];
    OldDimText: Text[120];
    Qty: Decimal;
    ...
    Contract_No_CaptionLbl: TextConst ENU = 'Contract No.', ESM = 'Nº contrato', FRC = 'N° de contrat', ENC = 'Contract No.';
    Service_Header___Order_Date_CaptionLbl: TextConst ENU = 'Order Date', ESM = 'Fecha pedido', FRC = 'Date de commande', ENC = 'Order Date';
    Invoice_toCaptionLbl: TextConst ENU = 'Invoice to', ESM = 'Facturar a', FRC = 'Facture à', ENC = 'Invoice to';
    CompanyInfo__Phone_No__CaptionLbl: TextConst ENU = 'Phone No.', ESM = 'Nº teléfono', FRC = 'N° téléphone', ENC = 'Phone No.';
    CompanyInfo__Fax_No__CaptionLbl: TextConst ENU = 'Fax No.', ESM = 'Nº fax', FRC = 'N° télécopieur', ENC = 'Fax No.';
    Service_Header___Phone_No__CaptionLbl: TextConst ENU = 'Phone No.', ESM = 'Nº teléfono', FRC = 'N° téléphone', ENC = 'Phone No.';
    Service_Header___E_Mail_CaptionLbl: TextConst ENU = 'Email', ESM = 'Correo electrónico', FRC = 'Courriel', ENC = 'Email';
    ...
    Service_Item_LinesCaptionLbl: TextConst ENU = 'Service Item Lines', ESM = 'Líns. prod. servicio', FRC = 'Lignes article de service', ENC = 'Service Item Lines';
    Service_Item_Line__Response_Date_CaptionLbl: TextConst ENU = 'Response Date', ESM = 'Fecha respuesta', FRC = 'Date de réponse', ENC = 'Response Date';
    Service_Item_Line__Response_Time_CaptionLbl: TextConst ENU = 'Response Time', ESM = 'Hora respuesta', FRC = 'Temps de réponse', ENC = 'Response Time';
    Fault_CommentsCaptionLbl: TextConst ENU = 'Fault Comments', ESM = 'Comentarios defecto', FRC = 'Commentaires panne', ENC = 'Fault Comments';
    Resolution_CommentsCaptionLbl: TextConst ENU = 'Resolution Comments', ESM = 'Comentarios resolución', FRC = 'Commentaires solution', ENC = 'Resolution Comments';
    QtyCaptionLbl: TextConst ENU = 'Quantity', ESM = 'Cantidad', FRC = 'Quantité', ENC = 'Quantity';
    Service_LinesCaptionLbl: TextConst ENU = 'Service Lines', ESM = 'Líneas servicio', FRC = 'Lignes de service', ENC = 'Service Lines';
    AmountCaptionLbl: TextConst ENU = 'Amount', ESM = 'Importe', FRC = 'Montant', ENC = 'Amount';
    Gross_AmountCaptionLbl: TextConst ENU = 'Gross Amount', ESM = 'Importe bruto', FRC = 'Montant brut', ENC = 'Gross Amount';
    ...
    Ship_to_AddressCaptionLbl: TextConst ENU = 'Ship-to Address', ESM = 'Dirección de envío', FRC = 'Adresse de livraison', ENC = 'Ship-to Address';
    ...
    begin
        ...
        if ShowShippingAddr then FormatAddr.ServiceOrderShipto(ShipToAddr, ServiceHeader);
    end;
