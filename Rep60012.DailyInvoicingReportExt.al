report 60012 "Daily Invoicing Report Ext"
{
    // version NAVNA13.00
    DefaultLayout = RDLC;
    RDLCLayout = './Daily Invoicing Report.rdl';
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                begin
                    if IncludeInvoices then begin
                        ...
                        if InvLine.FindSet(false)then repeat CostAmount+=(InvLine."Unit Cost (LCY)" * InvLine.Quantity);
            ...
            dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
            {
                ...
                begin
                    if IncludeCreditMemos then begin
                        ...
                        if CrMemoLine.FindSet(false)then repeat CostAmount+=(CrMemoLine."Unit Cost (LCY)" * CrMemoLine.Quantity);
            ...
            begin
                if UseCurrency then begin
                    if Number = 1 then TempCurrency.Find('-')
                    else
                        TempCurrency.Next;
                end;
                TotalAmtExclTax:=0.0;
            ...
            trigger OnPreDataItem();
            begin
                if UseCurrency then SetRange(Number, 1, TempCurrency.Count)
                else
                begin
                    SetRange(Number, 1);
                    Clear(TempCurrency);
