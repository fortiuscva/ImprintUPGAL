page 50044 "Repair Return Orders List-RO"
{
    // ISS2.00 10.31.13 DFP - Added call to FilterSalesperson in OnOpenPage
    // IMP1.01,11-Feb-16,ST: Created new page. ;
    Caption = 'Repair Return Orders List';
    CardPageID = "Repair Return Orders-RO";
    DelayedInsert = false;
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ...
    SourceTableView = WHERE("Document Type"=CONST("Return Order"), "Repair Order"=CONST(true));
    ApplicationArea = All;
    UsageCategory = Lists;
