page 50085 "Contacts - My Contact"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            action("Update Salesperson on Contacts")
            {
                Image = Report;
                Promoted = true;
                PromotedCategory = "Report";
                PromotedIsBig = true;
                RunObject = XMLport "Update Salesperson on Contacts";
                ApplicationArea = All;
            }
            action("Import New Company Contacts")
            {
                Image = Report;
                Promoted = true;
                PromotedCategory = "Report";
                PromotedIsBig = true;
                RunObject = XMLport "Import Company Contacts";
                ApplicationArea = All;
            }
