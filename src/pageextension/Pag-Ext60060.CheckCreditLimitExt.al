pageextension 60060 "CheckCreditLimitExt" extends "Check Credit Limit"
{
    ...
    begin
        ...
        CheckWarning(SalesHeader."Bill-to Customer No.", NewOrderAmountLCY, OldOrderAmountLCY, true)end;
    ...
    begin
        ...
        if ExitValue > 0 then begin
            case ExitValue of 1: CrLimitOnHoldCodeVarGbl:='CLE'; //Credit Limit Exceeded
            2: CrLimitOnHoldCodeVarGbl:='OVD'; //Over Due
            3: CrLimitOnHoldCodeVarGbl:='CLD'; // Credit Limit and Overdue
            end;
        end
        else
            CrLimitOnHoldCodeVarGbl:='';
    end;
    local procedure SalesLineAmount1(DocType: Integer; DocNo: Code[20]): Decimal var
        SalesLine: Record 37;
    begin
        SalesLine.RESET;
    ...
    local procedure CalcTotalOutstandingAmt1(): Decimal var
        SalesLine: Record 37;
