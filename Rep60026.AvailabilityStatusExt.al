report 60026 "Availability Status Ext"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Availability Status.rdlc';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                if BinContent.FindFirst then BinCode:=BinContent."Bin Code"
                else
                    Clear(BinCode);
            // End =================================================/
            end;
            ...
            begin
                if StrPos(Item.CurrentKey, FieldCaption("Inventory Posting Group")) = 0 then GroupKey:=false
                else
                    GroupKey:=true;
            end;
        }
