report 50018 "SP Stat. by Inv. Doc. Date"
{
    ...
    dataset
    {
        dataitem("Salesperson/Purchaser"; "Salesperson/Purchaser")
        {
            ...
            {
                DataItemLink = "Salesperson Code"=FIELD(Code), "Document Date"=FIELD("Date Filter");
    ...
    Salesperson_Statistics_by_InvoiceCaptionLbl: Label 'Salesperson Statistics by Invoice Doc. Date';
